...
function myblogger_woo_product_grid() {
    global $product;
    global $post;
    global $woocommerce;
    ?>
         ...
         <div class="product__action d-flex flex-column flex-wrap">
            ...
            <button type="button" class="product-action-btn">
               <svg width="15" height="15" viewBox="0 0 15 15" fill="none"
                  ...
                  <path d="M4.07452 8.32166L1.4889 10.9058L4.07452 13.4899" stroke="currentColor"
                     stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
...
add_action(  'woocommerce_before_shop_loop_item','myblogger_woo_product_grid',10 );