                  ...
                  <div class="accordion-item">
                     <h2 class="accordion-header" id="category__widget">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse"
                           data-bs-target="#cagetory_widget_collapse" aria-expanded="true"
                           aria-controls="cagetory_widget_collapse">
                           Categories
                        </button>
                     </h2>
                     <div id="cagetory_widget_collapse" class="accordion-collapse collapse show"
                        aria-labelledby="category__widget" data-bs-parent="#shop_category">
               ...
               <div class="accordion" id="shop_model">
                  <div class="accordion-item">
                     <h2 class="accordion-header" id="model__widget">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse"
                           data-bs-target="#model_widget_collapse" aria-expanded="true"
                           aria-controls="model_widget_collapse">
                           Model
                        </button>
                     </h2>
                     <div id="model_widget_collapse" class="accordion-collapse collapse show"
                        aria-labelledby="model__widget" data-bs-parent="#shop_model">
                        <div class="accordion-body">
               ...
               <div class="accordion" id="shop_color">
                  <div class="accordion-item">
                     <h2 class="accordion-header" id="color__widget">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse"
                           data-bs-target="#color_widget_collapse" aria-expanded="true"
                           aria-controls="color_widget_collapse">
                           Color
                        </button>
                     </h2>
                     <div id="color_widget_collapse" class="accordion-collapse collapse show"
            ...
            <div class="shop__widget tp-accordion">
               <div class="accordion" id="shop_price">
                  <div class="accordion-item">
                     ...
                     <div id="price_widget_collapse" class="accordion-collapse collapse show"
                                       ...
                                       <div class="product__list-action d-flex flex-wrap align-items-center">
                                          ...
                                          <button type="button" class="product-action-btn product-action-btn-2">
                                             <svg width="15" height="15" viewBox="0 0 15 15" fill="none"
                                                ...
                                                <path d="M1.48883 3.58386L14 3.58386" stroke="currentColor"
                                                   stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M4.07452 8.32166L1.4889 10.9058L4.07452 13.4899"
                                                   stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                                   stroke-linejoin="round" />
                                                <path d="M14 10.906H1.48883" stroke="currentColor" stroke-width="1.5"
                                                   stroke-linecap="round" stroke-linejoin="round" />
                                             </svg>
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-xl-7 col-lg-7">
                                    <div class="product__list-content">
                                       ...
                                       <h3 class="product__list-title">
                                          <a href="product-details.html">OnePlus 10 Pro tablet</a>
                                       </h3>
                                       <div class="product__list-price">
                                          <span class="product__list-ammount">$152.00</span>
                                       </div>
                                       <p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis
                                          praesentium voluptatum.…</p>
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-xl-7 col-lg-7">
                                    <div class="product__list-content">
                                       ...
                                       <h3 class="product__list-title">
                                          <a href="product-details.html">Apple Watch Series 7</a>
                                       </h3>
                                       <div class="product__list-price">
                                          <span class="product__list-ammount">$799.00</span>
                                       </div>
                                       <p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis
                                          praesentium voluptatum.…</p>
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-xl-7 col-lg-7">
                                    <div class="product__list-content">
                                       ...
                                       <h3 class="product__list-title">
                                          <a href="product-details.html">PlayStation VR Marvel's</a>
                                       </h3>
                                       <div class="product__list-price">
                                          <span class="product__list-ammount">$249.00</span>
                                       </div>
                                       <p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis
                                          praesentium voluptatum.…</p>
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-xl-7 col-lg-7">
                                    <div class="product__list-content">
                                       ...
                                       <h3 class="product__list-title">
                                          <a href="product-details.html">View Sonic VP2756-2K</a>
                                       </h3>
                                       <div class="product__list-price">
                                          <span class="product__list-ammount">$120.00</span>
                                       </div>
                                       <p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis
                                          praesentium voluptatum.…</p>
