        ...
        <div class="row">
            <div class="col-xxl-8 col-lg-8">
                <div class="postbox__main-wrapper">
                            ...
                            <div
                                ...
                                <div class="postbox__more-left d-flex align-items-center">
                                    ...
                                    <div class="postbox__more-content">
                                        ...
                                        <h4>
                                            <a href="<?php echo get_the_permalink($prev_post) ?>">
                                                <?php echo get_the_title($prev_post) ?> </a>
                                        </h4>
                                    </div>
                                </div>
                    ...
                    // Arguments to fetch related posts by category or tag
                    $args = array(
                        'post_type' => $post_type, // Post type
                        'posts_per_page' => 4, // Number of related posts to display
                        'post__not_in' => array(get_the_ID()), // Exclude the current post
                        'orderby' => 'rand', // Random order for related posts
                        'tax_query' => array(
                            array(
                                'taxonomy' => 'category', // Use 'category' or 'post_tag'
                                'field' => 'term_id',
                                'terms' => wp_get_post_categories(get_the_ID()), // Fetch related posts by category
                            ),
                        ),
                    );
